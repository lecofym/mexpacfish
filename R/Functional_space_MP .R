setwd("C:/Users/rbk26/OneDrive/Documentos/Datos_Artículo/R/R_Rev")
...
traits<- read.csv('Fish Traits.csv',
...
###Para todos los traits (si solo quieres tener el dato)
trait_distribution <- traits.province %>%
  mutate(across(everything(), as.character)) %>%
  pivot_longer(cols = c("Size", "Mobility", "Activity", "Gregariousness", "Position", "Diet"), 
               names_to = "trait", values_to = "value") %>%
  group_by(trait, value) %>%
  count()


anyNA(traits.province)
is.na(traits.province)
colSums(is.na(traits.province))
...
Size<- ggplot(data = traits.province,
  ...
  # Size 1
  annotate('text', x = 0.72, y = 2.3, label = '32')+
  annotate('text', x = 0.87, y = 4.6, label = '92')+
  annotate('text', x = 1.0, y = 1.3, label = '18')+
  annotate('text', x = 1.15, y = 2.3, label = '41')+
  annotate('text', x = 1.29, y = 0.6, label = '2')+
  # Size 2
  annotate('text', x = 1.72, y = 2.7, label = '46')+
  annotate('text', x = 1.85, y = 7.5, label = '153')+
  annotate('text', x = 2.00, y = 2.8, label = '54')+
  annotate('text', x = 2.15, y = 3.5, label = '70')+
  annotate('text', x = 2.28, y = 1.1, label = '14')+
  # Size 3
  annotate('text', x = 2.72, y = 4.5, label = '78')+
  annotate('text', x = 2.85, y = 11.3, label = '235')+
  annotate('text', x = 3.0, y = 5.6, label = '114')+
  annotate('text', x = 3.15, y = 5.6, label = '116')+
  annotate('text', x = 3.28, y = 1.3, label = '19')+
  # Size 4
  annotate('text', x = 3.72, y = 3.6, label = '68')+
  annotate('text', x = 3.85, y = 9.8, label = '204')+
  annotate('text', x = 4.0, y = 4.1, label = '83')+
  annotate('text', x = 4.15, y = 5.1, label = '105')+
  annotate('text', x = 4.28, y = 1.2, label = '16')+
  # Size 5
  annotate('text', x = 4.72, y = 2.8, label = '49')+
  annotate('text', x = 4.85, y = 5.9, label = '109')+
  ...
  annotate('text', x = 5.85, y = 6.5, label = '118')+
  annotate('text', x = 6.00, y = 4.4, label = '72')+
  annotate('text', x = 6.15, y = 4.4, label = '77')+
  ...
  annotate('text', x = 6.4, y = 12, label = 'c', size = 14)
Size
...
Diet<- ggplot(data = traits.province,
  ...
  annotate('text', x = 0.82, y = 15.7, label = '330')+
  ...
  # IM diet
  annotate('text', x = 2.64, y = 7.3, label = '114')+
  annotate('text', x = 2.82, y = 17.3, label = '338')+
  annotate('text', x = 3.01, y = 6.7, label = '132')+
  annotate('text', x = 3.19, y = 8.3, label = '169')+
  ...
  annotate('text', x = 5.82, y = 6.5, label = '107')+
  ...
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
        legend.position = 'none')+
  annotate('text', x = 5.9, y = 20, label = 'd', size = 14)
Diet
...
Mob<- ggplot(data = traits.province,
  ...
  # Mobility 1
  annotate('text', x = 0.73, y = 7.3, label = '122')+
  annotate('text', x = 0.86, y = 17.1, label = '327')+
  annotate('text', x = 1.0, y = 6.7, label = '109')+
  annotate('text', x = 1.14, y = 8.1, label = '139')+
  ...
  annotate('text', x = 2.86, y = 10.6, label = '221')+
  ...
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
        legend.position = 'none')+
  annotate('text', x = 4.5, y = 17.5, label = 'a', size = 14)
Mob
...
Greg<- ggplot(data = traits.province,
  ...
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
        legend.position = 'none')+
  annotate('text', x = 4.5, y = 30, label = 'b', size = 14)
Greg
...
Pos<- ggplot(data = traits.province,
  ...
  annotate('text', x = 5, y = 30, label = 'e', size = 14)
Pos
...
Act<- ggplot(data = traits.province,
  ...
  annotate('text', x = 0.83, y = 35.4, label = '748')+
  annotate('text', x = 1.00, y = 15.5, label = '317')+
  annotate('text', x = 1.18, y = 18.0, label = '365')+
  annotate('text', x = 1.36, y = 4.2, label = '52')+
  # Activity 2
  annotate('text', x = 1.64, y = 5.1, label = '59')+
  annotate('text', x = 1.83, y = 10.4, label = '163')+
  ...
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
        legend.position = 'bottom')+
  annotate('text', x = 2.35, y = 40, label = 'f', size = 14)
Act
