...
presence<- origin[, c(4:1048)] ###  1048 (actualizar cada que se cambia de base de datos)
...
# Data per region. ### (Cambiar número de especies cada que se cambia de base de datos)
provinces
calif.peru <- regional.space %>%
  filter(Californian == '1') # 314 species
cortez <- regional.space %>%
  filter(Cortez == '1') # 911 species
oceanic <- regional.space %>%
  filter(Oceanic == '1') # 393 species
panamic <- regional.space %>%
  filter(Panamic == '1') # 465 species
...
traits.province$Province <- factor(traits.province$Province,
                                   levels = c('Californian', 'Cortez', 'Oceanic',
                                              'Panamic', 'Backbone'),
                                   ordered = T)
#write.csv(traits.province,file="ComprobaciónAtributos.csv")


# Trait frequency distribution ####
# Composition per trait
#traits.province %>% group_by(trait) %>% count() ### (group_by("inserte aqui "trait")
# e.g.
#traits.province %>% group_by(Size) %>% count()
#traits.province %>% group_by(Activity) %>% count() # ... etc etc

View(traits.province)
...
Size<- ggplot(data = traits.province,
  ...
  scale_x_continuous(breaks = seq(1, 6, by = 1), labels=c("5-7 cm", "7.1-15 cm", "15.1-30 cm", "30.1-50 cm", "50.1-80 cm",">80 cm"))+
  # Size 1
  annotate('text', x = 0.72, y = 2.0, label = '32')+
  annotate('text', x = 0.87, y = 4.7, label = '92')+
  annotate('text', x = 1.0, y = 1.3, label = '18')+
  annotate('text', x = 1.15, y = 2.3, label = '41')+
  annotate('text', x = 1.29, y = 0.6, label = '2')+
  # Size 2
  annotate('text', x = 1.72, y = 2.5, label = '46')+
  annotate('text', x = 1.85, y = 7.6, label = '153')+
  annotate('text', x = 2.00, y = 3.0, label = '54')+
  annotate('text', x = 2.15, y = 3.8, label = '70')+
  annotate('text', x = 2.28, y = 1.1, label = '14')+
  # Size 3
  annotate('text', x = 2.72, y = 3.8, label = '78')+
  annotate('text', x = 2.85, y = 11.4, label = '235')+
  annotate('text', x = 3.0, y = 5.5, label = '114')+
  annotate('text', x = 3.15, y = 5.7, label = '116')+
  annotate('text', x = 3.28, y = 1.3, label = '19')+
  # Size 4
  annotate('text', x = 3.72, y = 3.6, label = '68')+
  annotate('text', x = 3.85, y = 9.8, label = '204')+
  annotate('text', x = 4.0, y = 4.3, label = '83')+
  annotate('text', x = 4.15, y = 5.3, label = '105')+
  annotate('text', x = 4.28, y = 1.2, label = '16')+
  # Size 5
  annotate('text', x = 4.72, y = 2.8, label = '49')+
  annotate('text', x = 4.85, y = 5.4, label = '109')+
  annotate('text', x = 5.00, y = 3.1, label = '52')+
  annotate('text', x = 5.15, y = 3.3, label = '56')+
  annotate('text', x = 5.28, y = 1.0, label = '11')+
  # Size 6
  annotate('text', x = 5.72, y = 2.6, label = '41')+
  annotate('text', x = 5.85, y = 6.3, label = '118')+
  annotate('text', x = 6.00, y = 4.2, label = '72')+
  annotate('text', x = 6.15, y = 4.2, label = '77')+
  annotate('text', x = 6.28, y = 1.1, label = '12')+
  theme_classic()+
...
Diet<- ggplot(data = traits.province,
  ...
  # FC diet
  annotate('text', x = 0.64, y = 6.1, label = '115')+
  annotate('text', x = 0.82, y = 16, label = '330')+
  annotate('text', x = 1.01, y = 8.1, label = '156')+
  annotate('text', x = 1.19, y = 9.1, label = '171')+
  annotate('text', x = 1.36, y = 2.1, label = '25')+
  # HD diet
  annotate('text', x = 1.64, y = 1.4, label = '12')+
  annotate('text', x = 1.82, y = 3.9, label = '74')+
  annotate('text', x = 2.01, y = 2.5, label = '23')+
  annotate('text', x = 2.19, y = 2.3, label = '30')+
  annotate('text', x = 2.36, y = 1.1, label = '4')+
  # IM diet
  annotate('text', x = 2.64, y = 6, label = '114')+
  annotate('text', x = 2.82, y = 16.3, label = '338')+
  annotate('text', x = 3.01, y = 6.7, label = '132')+
  annotate('text', x = 3.19, y = 8.2, label = '169')+
  annotate('text', x = 3.36, y = 2.3, label = '23')+
  # IS diet
  annotate('text', x = 3.64, y = 1.2, label = '4')+
  annotate('text', x = 3.82, y = 2.0, label = '22')+
  annotate('text', x = 4.01, y = 1.4, label = '12')+
  annotate('text', x = 4.19, y = 1.5, label = '12')+
  annotate('text', x = 4.36, y = 1.1, label = '2')+
  # OM diet
  annotate('text', x = 4.64, y = 1.6, label = '19')+
  annotate('text', x = 4.82, y = 2.7, label = '40')+
  annotate('text', x = 5.01, y = 1.8, label = '22')+
  annotate('text', x = 5.19, y = 2.1, label = '26')+
  annotate('text', x = 5.36, y = 1.2, label = '7')+
  # Pk diet
  annotate('text', x = 5.64, y = 3.7, label = '50')+
  annotate('text', x = 5.82, y = 5.7, label = '107')+
  annotate('text', x = 6.01, y = 3.3, label = '48')+
  annotate('text', x = 6.19, y = 3.8, label = '57')+
  annotate('text', x = 6.36, y = 1.3, label = '13')+
  theme_classic()+
  scale_fill_manual(values=province.cols)+
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
...
Mob<- ggplot(data = traits.province,
  ...
  # Mobility 1
  annotate('text', x = 0.73, y = 6.7, label = '122')+
  annotate('text', x = 0.86, y = 15.7, label = '327')+
  annotate('text', x = 1.0, y = 6.7, label = '109')+
  annotate('text', x = 1.14, y = 7.1, label = '139')+
  annotate('text', x = 1.28, y = 2.3, label = '30')+
  # Mobility 2
  annotate('text', x = 1.73, y = 5.3, label = '88')+
  annotate('text', x = 1.86, y = 10.0, label = '199')+
  annotate('text', x = 2.0, y = 4.6, label = '80')+
  annotate('text', x = 2.14, y = 4.9, label = '91')+
  annotate('text', x = 2.28, y = 1.6, label = '16')+
  # Mobility 3
  annotate('text', x = 2.73, y = 3.7, label = '56')+
  annotate('text', x = 2.86, y = 10.9, label = '221')+
  annotate('text', x = 3.0, y = 4.4, label = '81')+
  annotate('text', x = 3.14, y = 6.4, label = '125')+
  annotate('text', x = 3.28, y = 1.6, label = '13')+
  # Mobility 4
  annotate('text', x = 3.73, y = 3.2, label = '48')+
  annotate('text', x = 3.86, y = 8.0, label = '164')+
  annotate('text', x = 4.0, y = 6.1, label = '123')+
  annotate('text', x = 4.14, y = 5.5, label = '110')+
...
Greg<- ggplot(data = traits.province,
  ...
  # Gregariousness 1
  annotate('text', x = 0.73, y = 12.6, label = '209')+
  annotate('text', x = 0.86, y = 29.2, label = '588')+
  annotate('text', x = 1.0, y = 12.1, label = '220')+
  annotate('text', x = 1.14, y = 14.8, label = '279')+
  annotate('text', x = 1.28, y = 3.1, label = '34')+
  # Gregariousness 2
  annotate('text', x = 1.73, y = 1.6, label = '4')+
  annotate('text', x = 1.86, y = 2.0, label = '12')+
  annotate('text', x = 2.0, y = 1.9, label = '10')+
  annotate('text', x = 2.14, y = 1.8, label = '8')+
  annotate('text', x = 2.28, y = 1.5, label = '2')+
  # Gregariousness 3
  annotate('text', x = 2.73, y = 4.7, label = '76')+
  annotate('text', x = 2.86, y = 11.7, label = '228')+
  annotate('text', x = 3.0, y = 6.8, label = '125')+
  annotate('text', x = 3.14, y = 6.8, label = '125')+
  annotate('text', x = 3.28, y = 2.8, label = '32')+
  # Gregariousness 4
  annotate('text', x = 3.73, y = 2.5, label = '25')+
  annotate('text', x = 3.86, y = 4.9, label = '83')+
...
Pos<- ggplot(data = traits.province,
  ...
  # Position 1
  annotate('text', x = 0.72, y = 9.8, label = '189')+
  annotate('text', x = 0.86, y = 29.1, label = '595')+
  annotate('text', x = 1.00, y = 10.5, label = '186')+
  annotate('text', x = 1.14, y = 14.2, label = '271')+
  annotate('text', x = 1.28, y = 3.3, label = '42')+
  # Position 2
  annotate('text', x = 1.72, y = 6.3, label = '73')+
  annotate('text', x = 1.86, y = 9.4, label = '171')+
  annotate('text', x = 2.00, y = 5.9, label = '101')+
  annotate('text', x = 2.14, y = 6.3, label = '111')+
  annotate('text', x = 2.28, y = 2.3, label = '17')+
  # Position 3
  annotate('text', x = 2.72, y = 3.9, label = '52')+
  annotate('text', x = 2.86, y = 7.9, label = '145')+
  annotate('text', x = 3.00, y = 6.0, label = '106')+
  annotate('text', x = 3.14, y = 5.0, label = '83')+
...
Act<- ggplot(data = traits.province,
  ...
  # Activity 1
  annotate('text', x = 0.64, y = 14.4, label = '255')+
  annotate('text', x = 0.83, y = 36, label = '748')+
  annotate('text', x = 1.00, y = 15.7, label = '317')+
  annotate('text', x = 1.18, y = 18.3, label = '365')+
  annotate('text', x = 1.36, y = 4.2, label = '52')+
  # Activity 2
  annotate('text', x = 1.64, y = 5.1, label = '59')+
  annotate('text', x = 1.83, y = 10.3, label = '163')+
  annotate('text', x = 2.00, y = 6.4, label = '76')+
  annotate('text', x = 2.18, y = 7.1, label = '100')+
  annotate('text', x = 2.36, y = 3.0, label = '22')+
  theme_classic()+
  scale_fill_manual(values=province.cols)+
  theme(panel.grid = element_blank(),
        text = element_text(size = 15),
...
dim(sub.calif.peru) # 196 unique FEs
...
dim(sub.oceanic) # 233 unique FEs
...
dim(sub.panamic) # 262 unique FEs
...
dim(sub.backbone) # 64 unique FEs
...
regional.volume<- data.frame(Province = c(rep(provinces, each = 5)),
                             Metric = c(metrics),
                             Value = c(314, (314/1045)*100, 196, (196/421)*100, chCaliPeru,
                                       911,(911/1045)*100, 382, (382/421)*100, chCor,
                                       393, (393/1045)*100, 233, (233/421)*100, chOce,
                                       465, (465/1045)*100, 265, (265/421)*100, chPan,
                                       74, (74/1045)*100, 54, (54/421)*100, chBack))
...
hist.caliperu<- regional.volume %>%
  ...
  annotate('text', x = 1, y = 54, label = '314', size = 7)+
  annotate('text', x = 2, y = 38, label = '196', size = 7)+
  annotate('text', x = 3, y = 80, label = '73', size = 7)+
  theme_classic()+
...
hist.cortez<- regional.volume %>%
  ...
  scale_y_continuous(limits = c(0, 100),
                     breaks = seq(0, 100, by = 20))+
  annotate('text', x = 1, y = 98, label = '911', size = 7)+
  annotate('text', x = 2, y = 94, label = '382', size = 7)+
  annotate('text', x = 3, y = 101, label = '96', size = 7)+
  theme_classic()+
...
hist.oceanic<- regional.volume %>%
  ...
  scale_y_continuous(limits = c(0, 100),
                     breaks = seq(0, 100, by = 20))+
  annotate('text', x = 1, y = 63, label = '393', size = 7)+
  annotate('text', x = 2, y = 45, label = '233', size = 7)+
...
hist.panamic<- regional.volume %>%
  ...
  scale_y_continuous(limits = c(0, 100),
                     breaks = seq(0, 100, by = 20))+
  annotate('text', x = 1, y = 70, label = '465', size = 7)+
  annotate('text', x = 2, y = 52, label = '265', size = 7)+
...
hist.backbone<- regional.volume %>%
  ...
  scale_y_continuous(limits = c(0, 100),
                     breaks = seq(0, 100, by = 20))+
  annotate('text', x = 1, y = 19, label = '74', size = 7)+
  annotate('text', x = 2, y = 13, label = '58', size = 7)+
  annotate('text', x = 3, y = 44, label = '38', size = 7)+
